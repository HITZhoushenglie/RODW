...
# from trl.import_utils import is_bitsandbytes_available, is_torchvision_available
...
class DDPOConfig:
    ...
    sample_guidance_scale: float = 10.5
    """Classifier-free guidance weight."""
    image_guidance_scale: float = 1.5
    """ image_ guidance weight. """
    ...
    per_prompt_stat_tracking_buffer_size: int = 32 
